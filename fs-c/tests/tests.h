...
static char test_str[] = "Graphic Card is life. I need a 1080 for Christmas. "
                         "As a side note, it's quite obvious when people copy "
                         "from github. Usually there's more than one guy "
